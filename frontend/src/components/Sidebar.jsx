  ...
  return (
    <div className="bg-gray-100 w-64 p-4">
      <ul className='flex flex-col gap-5'>
        <li className="mb-2">
          <Link to="/home" className="text-gray-700 flex gap-2">
            <Home className='text-gray-700'/>
            Home
          </Link>
        </li>
        <li className="mb-2">
          <Link to="/projects" className="text-gray-700 flex gap-2">
            <FolderKanban className='text-gray-700'/>
            Projects
          </Link>
        </li>
        <li className="mb-2">
          <Link to="/logs" className="text-gray-700 flex gap-2">
            <Logs className='text-gray-700'/>
            Logs
          </Link>
        </li>
        <li className="mb-2">
          <Link to="/settings" className="text-gray-700 flex gap-2">
